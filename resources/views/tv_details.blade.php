        ...
        <div class="w-full h-screen flex flex-col relative">
            ...
            <div id="trailerWrapper" class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col">
                <button class="ml-auto group mb-4" onclick="showTrailer(false)">
                  ...
                  <iframe id="youtubeVideo" class="w-full h-full" src="https://www.youtube.com/embed/{{$trailerID}}?enablejsapi=1" title="{{$tvData->name}}" frameborder="0" allow="accelerometer; autoplay; clipbord-write; ancrypted-media; gyroscape; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
