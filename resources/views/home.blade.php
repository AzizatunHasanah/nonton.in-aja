        ...
        <div class="w-full h-auto min-h-screen flex flex-col">
            ...
            <div class="w-full h-[512px] flex flex-col relative bg-black">
                ...
                <div class="w-10/12 flex flex-col ml-28 z-10">
                    ...
                    <a href="/movie/{{$bannerItem->id}}" class="w-fit bg-blue-500 text-white pl-2 pr-4 py-2 mt-5 font-inter text-sm flex flex-row rounded-full items-center hover:drop-shadow-lg duration-200">
            ...
            <div class="">
                ...
                <div class="w-auto flex flex-row overflow-x-auto pl-28 pt-6 pb-10">
                    ...
                    @php
                        ...
                        $tvShowsRating = $tvShowsItem->vote_average;
