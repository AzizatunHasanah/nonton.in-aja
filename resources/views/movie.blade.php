...
<body>
    <div class="w-full h-auto min-h-screen flex flex-col">
        ...
        <!-- Content Section-->
        <div class="w-auto pl-28 pr-10 pt-6 pb-10 grid grid-cols-3 lg:grid-cols-6 gap-5" id="dataWrapper">
            ...
            <a href="movie/{{$movieID}}" class="group">
                <div class="min-w-[232px] min-h-[428px] bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col mr-8 duration-100">
        ...
        <div class="w-full pl-28 pr-10" id="loadMore">
            <button class="w-full mb-10 bg-blue-500 text-white p-4 font-inter font-bold rounded-xl uppercase drop-shadow" onclick="loadMore()">Load More</button>
        </div>
      ...
      .done(function (response){
        ...
        if (response.results){
          ...
          response.results.forEach(item => {
            ...
            let movieRating = item.vote_average;
